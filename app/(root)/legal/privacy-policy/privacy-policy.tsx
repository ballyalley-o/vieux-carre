    ...
    return (
      <section className={'relative'}>
        ...
        <div className={'space-y-8 h-[500px] overflow-auto'}>
          ...
          <ul className={'space-y-4 gap-2 ml-5 my-5'}>
            ...
            <li>
              <p>
                ...
                <a href="vieuxcarre.app" rel="external nofollow noopener" target="_blank">
                  vieuxcarre.app
                </a>
              </p>
            </li>
          ...
          <div className={'ml-5 space-y-4 gap-2'}>
          ...
          <p>
            ...
            already associated with Your Third-Party Social Media Service&apos;s account, such as Your name, Your email address, Your activities or
          ...
          <p>
            ...
            when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the &nbsp;
            <Link

...
interface TermsOfUseRawProps {
  appName: string
  email  : string
  appUrl : string
}

const TermsOfUseRaw = ({ appName, appUrl, email }: TermsOfUseRawProps) => {
    return (
      <section className={'relative'}>
        ...
        <div className={'space-y-8 h-[500px] overflow-auto'}>
          <h3 className={'text-2xl'}>{appName} {transl('legal.terms_of_use')}</h3>
            ...
            <ul className={'space-y-4 gap-2 ml-5 my-5'}>
              ...
              <li>
                <p>
                  ...
                  Agreement) refers to Vieux Carré.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Vieux Carré, accessible from{' '}
                  <Link href={appUrl} rel="external nofollow noopener" target="_blank">
                    <Badge variant={'secondary'} className={'text-md'}>{appName}</Badge>
                  </Link>
                </p>
              </li>
              <li>
            ...
            <h2 className={'text-2xl'}>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
            <p>
